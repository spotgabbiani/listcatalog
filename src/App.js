...
class App extends Component {
  ...
  selectedCatalog(index) {
    this.setState({ catalogSelected: catalogs[this.currentIndex] });
  }

  previousClick() {
    const newIndex =
      this.state.currentIndex === 0 ? 3 : this.state.currentIndex - 1;

    this.setState({
      currentIndex: newIndex,
      catalogSelected: catalogs[newIndex],
    });
  }

  nextClick() {
    const newIndex =
      this.state.currentIndex === 3 ? 0 : this.state.currentIndex + 1;
